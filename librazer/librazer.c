...
static const struct razer_mouse_base_ops razer_deathadder_essential_base_ops = {
	.type		= RAZER_MOUSETYPE_DEATHADDER,
	.init		= razer_deathadder_essential_init,
	.release	= razer_deathadder_essential_release,
};

static const struct razer_mouse_base_ops razer_deathadder_elite_base_ops = {
	.type    = RAZER_MOUSETYPE_DEATHADDER,
...
static const struct razer_mouse_base_ops razer_lancehead_base_ops = {
	.type    = RAZER_MOUSETYPE_DEATHADDER,
...
static const struct razer_usb_device razer_usbdev_table[] = {
	...
	USB_MOUSE(0x1532, 0x0060, &razer_lancehead_base_ops), /* Lancehead Tournament Edition */
	USB_MOUSE(0x1532, 0x005E, &razer_lancehead_base_ops), /* Lancehead (wired) */
